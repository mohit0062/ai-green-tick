        ...
        <div className="mx-auto max-w-4xl border-x border-[#C5C4C2] px-4 sm:px-6 lg:px-8 py-10 space-y-10">
          ...
          <article className="space-y-8">
            <header className="space-y-6 font-sans">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-display leading-tight tracking-tight text-black">
                {post.title}
              </h1>
          ...
          >
            <div className="flex flex-col items-center gap-3">
              ...
              <h3 className="text-xl sm:text-2xl font-display font-bold text-black">
                ...
                {relatedPosts.map((rPost) => (
                  ...
                  >
                    ...
                    <div className="p-5 flex flex-col flex-grow gap-3">
                      ...
                      <h4 className="text-xs font-extrabold text-black group-hover:text-[#00b259] transition-colors line-clamp-2 font-display leading-snug">
                        {rPost.title}
                      </h4>
