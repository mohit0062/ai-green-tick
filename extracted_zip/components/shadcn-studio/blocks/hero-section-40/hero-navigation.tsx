    ...
    <NavigationMenu viewport={false} className={cn('hidden lg:block', navigationClassName)}>
      <NavigationMenuList className='flex-wrap gap-0'>
        {navigationData.map(navItem => {
          ...
          return (
            <NavigationMenuItem key={navItem.title}>
              <NavigationMenuTrigger className='text-muted-foreground hover:text-primary focus:text-primary data-open:text-primary data-open:focus:text-primary data-open:hover:text-primary bg-transparent px-3 py-1.5 text-base hover:bg-transparent focus:bg-transparent data-open:bg-transparent data-open:hover:bg-transparent data-open:focus:bg-transparent [&_svg]:ml-2 [&_svg]:size-4'>
                {navItem.title}
              </NavigationMenuTrigger>
