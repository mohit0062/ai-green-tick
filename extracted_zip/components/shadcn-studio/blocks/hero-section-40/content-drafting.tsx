...
import { ThumbsUpIcon, FileChartPieIcon, LoaderIcon, Clock8Icon, MessageSquareTextIcon } from 'lucide-react'
  ...
  return (
    <div className='flex max-md:flex-col max-md:space-y-8 md:items-start'>
      <WorkflowItem
        ...
        time='0.0 sec'
        className='relative text-base md:mr-4 md:w-70 md:self-end'
      >
      ...
      <WorkflowItem
        ...
        time='16 sec'
        delay={1.2}
        className='relative text-base md:mt-3 md:mr-16'
      >
      ...
      <div className='flex flex-col gap-8 md:gap-6'>
        <WorkflowItem
          ...
          time='6 min'
          delay={2.4}
          className='relative text-base md:w-70'
        >
          <div className='bg-muted rounded-lg px-2.5 py-3'>
            <div className='flex items-center gap-2'>
              <img
