    ...
    <section className='bg-muted py-8 sm:py-16 lg:py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='relative'>
          <div className='from-muted pointer-events-none absolute inset-y-0 left-0 z-1 w-35 bg-linear-to-r to-transparent' />
          <div className='from-muted pointer-events-none absolute inset-y-0 right-0 z-1 w-35 bg-linear-to-l to-transparent' />
          <div className='w-full overflow-hidden'>
            <Marquee pauseOnHover duration={20} gap={1.5}>
              {brandLogos.slice(0, 7).map((logo, index) => (
                <Card key={index} className='rounded-lg py-6 shadow-md ring-0'>
