          ...
          <div className='bg-muted grid grid-cols-1 gap-6 rounded-xl p-6 max-sm:p-2 sm:grid-cols-2 lg:grid-cols-6'>
            ...
            >
              <Card className='shadow-none ring-0'>
                ...
                <CardHeader className='mt-4 gap-4'>
                  <CardTitle className='text-2xl font-semibold'>Smart Data Insights</CardTitle>
            ...
            >
              <Card className='h-full justify-between shadow-none ring-0'>
                ...
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl font-semibold'>Modular Dashboards</CardTitle>
                  <CardDescription className='text-lg font-medium'>
            ...
            >
              <Card className='h-full justify-between shadow-none ring-0'>
                ...
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl font-semibold'>Live Collaboration</CardTitle>
                  <CardDescription className='text-lg font-medium'>
            ...
            <MotionPreset
              ...
              delay={1.15}
            >
              <Card className='h-full justify-between shadow-none ring-0 lg:col-span-2'>
                <CardContent>
                  <WorkflowAutomation />
                </CardContent>
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl font-semibold'>Workflow Automation</CardTitle>
                  <CardDescription className='text-lg font-medium'>
            ...
            >
              <Card className='h-full justify-between shadow-none ring-0 lg:col-span-2'>
                ...
                <CardHeader className='gap-4'>
                  <CardTitle className='text-2xl font-semibold'>Integrated Data Security</CardTitle>
                  <CardDescription className='text-lg font-medium'>
