          ...
          <div>
            ...
            <div className='space-y-10'>
              {features.map((feature, index) => (
                ...
                >
                  <Avatar className='size-13 after:border-0'>
                    <AvatarFallback className='bg-muted text-foreground rounded-md'>{feature.icon}</AvatarFallback>
                  </Avatar>
                  <div className='md:space-y-1.5'>
                    <p className='text-lg font-medium md:text-2xl'>{feature.value}</p>
                    <p className='text-muted-foreground md:text-xl'>{feature.description}</p>
                  </div>
                </MotionPreset>
              ))}
            </div>
